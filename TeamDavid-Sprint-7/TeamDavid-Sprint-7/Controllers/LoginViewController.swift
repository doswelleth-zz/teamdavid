...
struct KeychainConfiguration {
    static let serviceName = "teamdavid"
...
class LoginViewController: UIViewController {
    ...
    private func checkLogin(username: String, password: String) -> Bool {
        ...
        do {
            ...
            NSLog("Error reading password from keychain\(error)")
        }
        return true
    }
    ...
    private func saveUserCredentials() {
        ...
        let entity = NSEntityDescription.entity(forEntityName: "TeamDavid", in: context)
    ...
    private func notesViewController() {
